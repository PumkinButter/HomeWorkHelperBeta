...
public class AddNewTask extends BottomSheetDialogFragment {
    ...
    private Button newImageSaveButton;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newImageSaveButton = getView().findViewById(R.id.newTaskButton2);
        ...
        db.openDatabase();
        newImageSaveButton.setOnClickListener(new View.OnClickListener() {
            @Override
